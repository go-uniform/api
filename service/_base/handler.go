...
func BindHandler(s diary.IPage, timeout time.Duration, topic string, extract func(r *http.Request) uniform.P, validateRequest func(data uniform.M) uniform.M, convertResponse func(response interface{}) []byte, permissions ...string) func(ctx *gin.Context) {
